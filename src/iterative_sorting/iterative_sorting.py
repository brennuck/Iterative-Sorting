...
def selection_sort(arr):
    ...
    for i in range(0, len(arr) - 1):
        ...
        for j in range(cur_index, len(arr)): # Loop through elements on right-hand-side of current index
            if arr[j] < arr[smallest_index]: # Compare elments to smallest index
                smallest_index = j
        # TO-DO: swap
